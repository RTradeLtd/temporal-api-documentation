...
The Lens API is used to perform indexing, and searching of files stored on IPFS through Temporal. Lens is *opt-in*, and available without signing up to Temporal.
